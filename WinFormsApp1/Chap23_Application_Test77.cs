...
namespace MyFirstCSharp
{
    ...
    public partial class Chap23_Application_Test77 : Form
    {
        ...
        Dictionary<string,int> dMargin= new Dictionary<string,int>();//이름은 문자열 인트는 마진이랑 결제금액.


        public Chap23_Application_Test77()
        {
            InitializeComponent();
            dMargin.Add("사과", 0);
            dMargin.Add("참외", 0);
        ...
        private void btnCumiteSale_Click(object sender, EventArgs e)
        {
            ...
            // 마진 처리하기
            dMargin["사과"] += iAppleCnt1 * iApplePrice;// 사과의 판매 내역이 마진에 등록.
            dMargin["참외"] += iMelCnt1 * iMelonPrice;  // 참외의 판매 내역이 마진에 등록
            dMargin["수박"] += iWMCnt1 * iWMPrice;     // 수박의 판매 내역이 마진에 등록
        }
        ...
        private void btnInvOrder_Click(object sender, EventArgs e)
        {
            ...
            dMargin["사과"] -= iAOrPrice;      // 사과의 판매 내역이 마진에 등록.
            dMargin["참외"] -= IWOrPrice;      // 참외의 판매 내역이 마진에 등록
            dMargin["수박"] -= IWWOrPrice;     // 수박의 판매 내역이 마진에 등록
        }
        ...
        private void btnMarginUnit_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show($"{sFuitName} 의 마진은 {dMargin["수박"]} 입니다.");
